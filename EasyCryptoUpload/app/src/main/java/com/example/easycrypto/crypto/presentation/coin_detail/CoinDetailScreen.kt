package com.example.easycrypto.crypto.presentation.coin_detail
...
import com.example.easycrypto.crypto.presentation.coin_detail.componenets.InfoCard
...
import com.example.easycrypto.crypto.presentation.models.toDisplayableNumber
import com.example.easycrypto.ui.theme.CryptoTrackerTheme
import com.example.easycrypto.ui.theme.greenBackground
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hr.value/100.0))
                        .toDisplayableNumber()
            ...
            AnimatedVisibility(
                ...
                LineChart(
                    ...
                    // updating it whenever the selected data point changes
                    onSelectedDataPoint = {
